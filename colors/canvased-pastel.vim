...
let s:white           = { "gui": "#d6d3ac", "cterm": "7"  }
let s:actual_white    = { "gui": "#FFFFFF", "cterm": "15" }
let s:light_black     = { "gui": "#26251c", "cterm": "8"   }
let s:lighter_black   = { "gui": "#837b61", "cterm": "8" }
let s:subtle_black    = { "gui": "#999f91", "cterm": "11" }
let s:light_gray      = { "gui": "#999999", "cterm": "12" }
let s:lighter_gray    = { "gui": "#CCCCCC", "cterm": "7" }
let s:lightest_gray   = { "gui": "#E5E5E5", "cterm": "13" }
let s:pink            = { "gui": "#d6acca", "cterm": "5"   }
let s:dark_red        = { "gui": "#8e7272", "cterm": "1"   }
let s:light_red       = { "gui": "#cca4a4", "cterm": "1"   }
let s:orange          = { "gui": "#ccbba4", "cterm": "9" }
let s:darker_blue     = { "gui": "#5a5a70", "cterm": "4"  }
let s:dark_blue       = { "gui": "#7b7b99", "cterm": "4"   }
let s:blue            = { "gui": "#b2abd4", "cterm": "4"  }
let s:light_blue      = { "gui": "#c0bbd4", "cterm": "4" }
let s:dark_cyan       = { "gui": "#788c96", "cterm": "6"   }
let s:light_cyan      = { "gui": "#aac7d4", "cterm": "6"  }
let s:dark_green      = { "gui": "#78967a", "cterm": "6"   }
let s:light_green     = { "gui": "#9fc6a1", "cterm": "6"  }
let s:dark_purple     = { "gui": "#786881", "cterm": "5"   }
let s:light_purple    = { "gui": "#b79fc6", "cterm": "5"  }
let s:light_yellow    = { "gui": "#e3d28d", "cterm": "3"  }
let s:dark_yellow     = { "gui": "#c4b67a", "cterm": "3"   }
