...
call s:h("TabLine",       {"fg": s:comment, "bg": s:cursor_line, "gui": "underline", "cterm": "underline"})
call s:h("TabLineSel",    {"fg": s:norm_bold, "bg": s:bg, "gui": "bold,underline", "cterm": "bold,underline"})
call s:h("TabLineFill",   {"fg": s:comment, "bg": s:cursor_line, "gui": "underline", "cterm": "underline"})
